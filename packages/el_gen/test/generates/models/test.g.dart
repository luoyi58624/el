...
extension TestModelExt on TestModel {
  ...
  static TestModel fromJson(Map<String, dynamic>? json) {
    ...
    return TestModel(
      ...
      listStringField3:
          $ElJsonUtil.$list<String>(json, 'listStringField3') ??
          ['hello', 'world'],
  ...
  TestModel copyWith({
    ...
    return TestModel(
      ...
      userModel2: this.userModel2 == null
          ? userModel2
          : this.userModel2!.merge(userModel2),
