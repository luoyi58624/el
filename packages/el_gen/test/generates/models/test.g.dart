...
extension TestModelExt on TestModel {
  static final TestModel defaultModel = TestModel(
    stringField: '',
    stringField3: 'hello',
    stringField4: 'hello',
    numField: 0.0,
    ...
    userModel: UserModelExt.defaultModel,
    ...
    myAnimal: AnimalModelExt.defaultModel,
    myDog: const AnimalModel(name: '旺财', type: '小狗'),
    animalList: [
      const AnimalModel(name: '旺财', type: '小狗'),
      const AnimalModel(name: '小白', type: '猫咪'),
    ],
  );
  ...
  static TestModel fromJson(Map<String, dynamic>? json) {
    ...
    return TestModel(
      ...
      listField:
          ElJsonUtil.$list<dynamic>(json, 'listField') ??
          [
            1,
            'hello',
            false,
      ...
      listField2: ElJsonUtil.$list<dynamic>(json, 'listField2') ?? [1, 'hello', false],
      listStringField: ElJsonUtil.$list<String>(json, 'listStringField') ?? [],
      listStringField2: ElJsonUtil.$list<String>(json, 'listStringField2'),
      listStringField3: ElJsonUtil.$list<String>(json, 'listStringField3') ?? ['hello', 'world'],
      ...
      listIntField3: ElJsonUtil.$list<int>(json, 'listIntField3') ?? [1, 2, 3, 4, 5],
      ...
      listDoubleField3: ElJsonUtil.$list<double>(json, 'listDoubleField3') ?? [1, 2, 3, 4, 5],
      ...
      mapField2:
          ElJsonUtil.$map<dynamic>(json, 'mapField2') ??
          {
            'name': 'hihi',
            'child': {'age': 20},
          },
      userModel:
          ElJsonUtil.$model<UserModel>(json, 'userModel', UserModelExt.defaultModel) ?? UserModelExt.defaultModel,
      userModel2:
          ElJsonUtil.$model<UserModel?>(json, 'userModel2', UserModelExt.defaultModel) ??
          const UserModel(
            username: 'hihi',
            age: 30,
            count: null,
      ...
      myAnimal:
          ElJsonUtil.$model<AnimalModel>(json, 'my_animal_model', AnimalModelExt.defaultModel) ??
          AnimalModelExt.defaultModel,
      myDog:
          ElJsonUtil.$model<AnimalModel?>(json, 'myDog', AnimalModelExt.defaultModel) ??
          const AnimalModel(name: '旺财', type: '小狗'),
      animalList:
          ElJsonUtil.$list<AnimalModel>(json, 'animalList') ??
          [const AnimalModel(name: '旺财', type: '小狗'), const AnimalModel(name: '小白', type: '猫咪')],
  ...
  TestModel copyWith({
    ...
    return TestModel(
      ...
      userModel2: this.userModel2 == null ? userModel2 : this.userModel2!.merge(userModel2),
      myAnimal: this.myAnimal.merge(myAnimal),
      myDog: this.myDog == null ? myDog : this.myDog!.merge(myDog),
