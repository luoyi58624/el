...
class _ElGoogleTabsState extends ElBaseTabsState<ElGoogleTabs> {
  ...
  @override
  Color get bgColor => widget.bgColor ?? (ElBrightness.isDark(context) ? Colors.grey.shade800 : Colors.grey.shade300);

  @override
  EdgeInsetsGeometry get tabPadding => const .only(top: googleTabPaddingTop);
  ...
  Widget buildTabs(BuildContext context) {
    ...
    final layoutWidth = widget.childMaxWidth + (widget.childMaxWidth - radius) * ($tabsData.children.value.length - 1);
          ...
          return Stack(
            children: [
              ElCustomMultiChildLayoutWidget(
                width: layoutWidth,
                delegateBuilder: (updateSize, isReBuild) => _GoogleTabLayoutDelegate(
                  updateSize,
                ...
                children: [
                  ...children.mapIndexed(
                    (i, e) => ElChildIndex(
                      ...
                      child: LayoutId(
                        id: i,
                        child: ClipPath(clipper: _GoogleTabClipper(radius), child: e),
                      ),
                    ),
                  ),
                ],
              ...
              ValueListenableBuilder(
                ...
                builder: (context, activeIndex, _) {
                  ...
                  Widget result = ClipPath(
                    ...
                    child: _TabActiveLayer(activeIndex, tabLayout.$2, $tabsData.children.value[activeIndex]),
                  );
                  return Positioned(left: tabLayout.$1, child: result);
                },
              ),
            ],
          );
...
class _GoogleTabLayoutDelegate extends MultiChildLayoutDelegate {
  _GoogleTabLayoutDelegate(this.updateSize, this.length, this.maxWidth, this.radius, this.setLayoutList);
