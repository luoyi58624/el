...
abstract class ElBaseTabsState<T extends ElBaseTabs> extends State<T> {
  ...
  Color get bgColor => widget.bgColor ?? context.elDefaultColor;

  EdgeInsetsGeometry get tabPadding => .zero;
...
abstract class ElBaseTab extends StatelessWidget {
  const ElBaseTab({super.key, required this.title, this.disabled = false, this.closable = true});
