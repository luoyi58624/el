...
//
//   /// ElImage 使用的缓存配置
//   static var defaultCacheManager = CacheManager(
//     Config('el_image_cache', stalePeriod: Duration(days: 3), maxNrOfCacheObjects: 10000),
//   );
//
//   @override
...
//     return Image.asset(src, width: width, height: height, fit: fit, package: package);
//   }
//
...
//       width: width,
//       height: height,
//       child: failWidget == null ? const Icon(Icons.error_outline_outlined) : failWidget!,
//     );
//   }
// }
