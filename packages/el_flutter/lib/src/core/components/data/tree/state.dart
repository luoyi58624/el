...
class _ElTreeState extends State<ElTree> {
  ...
  Widget buildItem(Map<String, dynamic> mapData) {
    return Container(
      ...
      decoration: BoxDecoration(borderRadius: treeThemeData.borderRadius),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      slivers: [ListView.builder(itemCount: widget.data.length, itemBuilder: (context, index) => SizedBox())],
    );
  }
}
