...
class _LineProgressPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size $size) {
    ...
    canvas.drawRect(Rect.fromLTRB(0, 0, $size.width, $size.height), paint..color = bgColor);
    ...
    canvas.drawRRect(RRect.fromRectAndRadius(Rect.fromLTRB(l, t, r, b), Radius.circular(radius)), paint..color = color);
  }
...
class _CricleProgressPainter extends CustomPainter {
  ...
  _CricleProgressPainter({required this.ratio, required this.strokeSize, required this.bgColor, required this.color});
  ...
  void paint(Canvas canvas, Size $size) {
    ...
    canvas.drawArc(rect2, -math.pi / 2, ratio * 2 * math.pi, false, paint..color = color);
  }
...
class _DashboardProgressPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size $size) {
    ...
    canvas.drawArc(rect2, _dashboardStart, _dashboardEnd, false, paint..color = bgColor);
    canvas.drawArc(rect2, _dashboardStart, ratio * _dashboardEnd, false, paint..color = color);
  }
