...
class _TableColumnScrollState extends State<_TableColumnScroll> {
  ...
  Widget build(BuildContext context) {
    return ScrollConfiguration(
      ...
      behavior: _TableScrollBehavior(enableScrollbar: widget.enableScrollbar, dragScroll: widget.dragScroll),
...
class _TableScrollBehavior extends ScrollBehavior {
  ...
  const _TableScrollBehavior({required this.enableScrollbar, this.dragScroll = false});
  ...
  Widget buildScrollbar(BuildContext context, Widget child, ScrollableDetails details) {
    switch (getPlatform(context)) {
      ...
      case TargetPlatform.iOS:
        ...
        return enableScrollbar ? Scrollbar(controller: details.controller, child: child) : child;
    }
  }
}
