...
@ElThemeGenerator()
class ElSplitResizerThemeData with EquatableMixin {
  ...
  const ElSplitResizerThemeData({this.axis, this.size, this.triggerSize, this.color, this.activeColor, this.position});
