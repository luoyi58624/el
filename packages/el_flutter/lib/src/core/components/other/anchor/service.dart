...
extension ElAnchorServiceExt on El {
  static final _instance = ElAnchorService();

  /// 瞄点服务
  ElAnchorService get anchor => _instance;
}

class ElAnchorService {
  /// 瞄点集合
  ...
  /// 设置锚点
  void setAnchor(String? key, GlobalKey value, {bool override = true}) {
    if (key != null) {
