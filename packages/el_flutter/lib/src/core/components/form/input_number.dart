...
enum _Slot { content, upButton, downButton }

class _InputNumberWidget extends RenderObjectWidget {
  const _InputNumberWidget({required this.content, required this.upButton, required this.downButton});
...
class _InputNumberElement extends RenderObjectElement {
  ...
  @override
  _InputNumberRender get renderObject => super.renderObject as _InputNumberRender;
  ...
  void update(_InputNumberWidget newWidget) {
    ...
    _content = updateChild(_content, newWidget.content, _Slot.content);
    _upButton = updateChild(_upButton, widget.upButton, _Slot.upButton);
    _downButton = updateChild(_downButton, widget.downButton, _Slot.downButton);
  }
...
class _InputNumberRender extends RenderBox {
  ...
  @override
  void performLayout() {
    content!.layout(BoxConstraints.tight(const Size(120, 40)), parentUsesSize: true);
    upButton!.layout(BoxConstraints.tight(const Size(24, 20)), parentUsesSize: true);
    downButton!.layout(BoxConstraints.tight(const Size(24, 20)), parentUsesSize: true);
    size = constraints.constrain(Size(content!.size.width + upButton!.size.width, content!.size.height));
  }
