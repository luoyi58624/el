...
class ElEditor extends StatefulWidget {
  const ElEditor({super.key, this.enabledMagnifier = true, this.onTap, this.onTapAlwaysCalled = false});
...
class ElEditorState extends State<ElEditor> implements TextSelectionGestureDetectorBuilderDelegate {
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: EditableText(
              ...
              // showSelectionHandles: true,
              selectionColor: focusNode.hasFocus ? context.elTheme.primary.elLight5(context) : null,
...
class _TextFieldSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  _TextFieldSelectionGestureDetectorBuilder({required ElEditorState state}) : _state = state, super(delegate: state);
