...
class _ScrollbarPainter extends ChangeNotifier implements CustomPainter {
  ...
  _ScrollbarPainter({
    ...
    bool ignorePointer = false,
       ...
       _paintSecondTrackBorder = paintSecondTrackBorder,
  ...
  bool get paintSecondTrackBorder => _paintSecondTrackBorder;
  bool _paintSecondTrackBorder;

  set paintSecondTrackBorder(bool value) {
    if (paintSecondTrackBorder == value) {
      return;
    }

    _paintSecondTrackBorder = value;
    notifyListeners();
  }
  ...
  ///
  /// Defaults to [.zero]. Offsets from all four directions must be
  ...
  void _paintScrollbar(Canvas canvas, Size size) {
    assert(textDirection != null, 'A TextDirection must be provided before a Scrollbar can be painted.');
    ...
    switch (_resolvedOrientation) {
      case ScrollbarOrientation.left:
        ...
        borderEnd1 = Offset(trackOffset.dx + trackSize.width, trackOffset.dy + _trackExtent);
      case ScrollbarOrientation.right:
        ...
        // MODIFY
        borderStart2 = trackOffset + Offset(thickness + crossAxisMargin * 2 + padding.horizontal, 0.0);
      ...
      case ScrollbarOrientation.top:
        ...
        borderEnd1 = Offset(trackOffset.dx + _trackExtent, trackOffset.dy + trackSize.height);
    ...
    if (trackBorderColor != Colors.transparent) {
      ...
      if (paintSecondTrackBorder && borderStart2 != null && borderEnd2 != null) {
  ...
  bool hitTestOnlyThumbInteractive(Offset position, PointerDeviceKind kind) {
    ...
    // ======================= START MODIFY ===========================
    bool isVertical =
        _resolvedOrientation == ScrollbarOrientation.right || _resolvedOrientation == ScrollbarOrientation.left;
    ...
    switch (kind) {
      ...
      case PointerDeviceKind.trackpad:
        final Rect touchThumbRect = thumbRect.expandToInclude(
          Rect.fromCircle(center: thumbRect.center, radius: _kMinInteractiveSize / 2),
        );
