...
/// Element UI 自定义滚动条实现
mixin _ElScrollbarMixin<T extends ElScrollbar> on SingleTickerProviderStateMixin<T> {
  late final AnimationController animationController;
  late final _ScrollbarPainter scrollbarPainter;

  /// 滚动条的显示模式
  late ElScrollbarShowMode showMode = widget.showMode;
  ...
  Color get defaultThumbColor =>
      widget.showMode == ElScrollbarShowMode.hover || widget.showMode == ElScrollbarShowMode.onlyScrolling
      ? widget.thumbColor.elOpacity(0)
      : widget.thumbColor;
  ...
  void updateScrollbarPainter() {
    scrollbarPainter
      ...
      ..paintSecondTrackBorder = widget.paintSecondTrackBorder
      ...
      ..ignorePointer = widget.ignorePointer == true;
  }

  @override
  void initState() {
    super.initState();
    animationController = AnimationController(vsync: this, duration: widget.fadeDuration)
      ..addListener(updateScrollbarPainter);
    scrollbarPainter = _ScrollbarPainter(color: scrollbarColor);
  }

  @override
  void didUpdateWidget(covariant oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.showMode != oldWidget.showMode ||
