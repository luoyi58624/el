  ...
  Widget build(BuildContext context) {
    ...
    switch (direction) {
      ...
      case AxisDirection.down:
        width = size;
        height = rightTriangle ? size / 2 : size;
        break;
      case AxisDirection.left:
      case AxisDirection.right:
        width = rightTriangle ? size / 2 : size;
        height = size;
        break;
    }
    final $color = color ?? Colors.grey;
    return CustomPaint(size: Size(width, height), painter: _Painter(direction, $color, radius, onlyRightAngle));
  }
}
  ...
  void radiusPaint(Canvas canvas, Size size, Path path) {
    ...
    switch (direction) {
      case AxisDirection.up:
        ...
        _RightAngle ra = (Rect.fromCircle(center: c1, radius: r), pi + pi / 4, pi / 2);
        ...
        if (onlyRightAngle) {
          ...
          path.arcTo(Rect.fromCircle(center: c2, radius: r), pi / 2, _diagonalAngle, false);
          ...
          path.arcTo(Rect.fromCircle(center: c3, radius: r), pi * 2 - pi / 4, _diagonalAngle, false);
        }
        break;
      case AxisDirection.right:
        c1 = Offset(w - r - r / 2, h / 2);
        _RightAngle ra = (Rect.fromCircle(center: c1, radius: r), pi + pi / 4 * 3, pi / 2);
        if (onlyRightAngle) {
          path.moveTo(0, 0);
          path.arcTo(ra.$1, ra.$2, ra.$3, false);
          path.lineTo(0, h);
          ...
          path.moveTo(0, c2.dy);
          path.arcTo(Rect.fromCircle(center: c2, radius: r), pi, _diagonalAngle, false);

          path.arcTo(ra.$1, ra.$2, ra.$3, false);

          path.lineTo(c3.dx + (r - arcLocation), c3.dy + (r - arcLocation));
          path.arcTo(Rect.fromCircle(center: c3, radius: r), 0, _diagonalAngle, false);
        }
        break;
      case AxisDirection.down:
        c1 = Offset(w / 2, h - r - r / 2);
        _RightAngle ra = (Rect.fromCircle(center: c1, radius: r), pi / 4, pi / 2);
        if (onlyRightAngle) {
          path.moveTo(0, 0);
          path.lineTo(w, 0);
          path.arcTo(ra.$1, ra.$2, ra.$3, false);
          ...
          path.arcTo(Rect.fromCircle(center: c2, radius: r), pi / 2 + pi / 4, _diagonalAngle, false);

          path.lineTo(c3.dx + (r - arcLocation), 0);
          path.arcTo(Rect.fromCircle(center: c3, radius: r), pi + pi / 2, _diagonalAngle, false);
      ...
      case AxisDirection.left:
        c1 = Offset(r + r / 2, h / 2);
        _RightAngle ra = (Rect.fromCircle(center: c1, radius: r), pi / 2 + pi / 4, pi / 2);
        if (onlyRightAngle) {
          path.moveTo(w, 0);
          path.lineTo(w, h);
          path.arcTo(ra.$1, ra.$2, ra.$3, false);
          ...
          path.arcTo(Rect.fromCircle(center: c2, radius: r), pi + pi / 4, _diagonalAngle, false);
