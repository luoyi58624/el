...
class _Box extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (style != null) {
      ...
      final decoration = style!.resolveDecoration;
      ...
      if (decoration != null) {
        ...
        if (decoration.color != null) {
          result = ElDefaultColor(decoration.color!, child: result);
        }
      } else if (style!.clipBehavior != null && style!.clipBehavior != Clip.none) {
        result = ClipRect(clipBehavior: style!.clipBehavior!, child: result);
      }
      ...
      if (style!.opacity != null && result != null) {
        result = Opacity(opacity: style!.opacity!, child: result);
      }

      if (style!.visible == false && result != null) {
        result = Visibility(visible: false, maintainSize: true, child: result);
      }
    }
  ...
  Widget buildAnimatedWidget(context, animation, tweenMap) {
    return _Box(
      style: ElBoxStyle(
        ...
        opacity: (tweenMap['opacity'] as Tween<double>?)?.evaluate(animation),
