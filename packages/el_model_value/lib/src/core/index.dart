import 'package:el_flutter/el_flutter.dart' show safeCallback, ElHookWidgetModelMixin;
...
abstract class ElModelValue<D> extends HookWidget with ElHookWidgetModelMixin {
  ...
  /// 访问 obs 响应式变量
  @protected
  Obs<D> get $obs => $get<Obs<D>>('obs');

  @override
  Widget build(BuildContext context) {
    final obs = $add('obs', _useModelValue<D>(value, modelValue, onChanged));
