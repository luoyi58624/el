...
class ElCheckbox extends StatelessWidget {
  ...
  /// }
  /// ```
  const ElCheckbox.indeterminate(
    Iterable<Object?> this.valueListData, {
    super.key,
    this.color,
    this.checkColor,
    this.borderColor,
        ...
        result = MouseRegion(
          ...
          child: GestureDetector(
            ...
            onTap: isDisabled
                ? null
                : () {
                    scope.hasElement(_selectedValue)
                        ? scope.removeElement(_selectedValue)
                        : scope.addElement(_selectedValue);
                  },
            child: Row(
