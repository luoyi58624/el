...
void main() {
  group('工具类测试', () {
    ...
    test('dynamicToList', () {
      ...
      final newList = El.dynamicToList<List<String>>(list);
      ...
      final newList3 = El.dynamicToList<List<String>>(newList2);
      expect(newList3.runtimeType.toString(), 'List<String>');
    });

    test('dynamicToMap', () {
      Map map = {'name': 'hihi', 'age': 20};
      Map<String, dynamic> castMap = El.dynamicToMap<Map<String, Object>>(map);
      ...
      Map castMap2 = El.dynamicToMap<Map<String, String>>(map2);
